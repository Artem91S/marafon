  ...
  return (
    ...
    <>
      ...
      <div className="flex w-full justify-between">
        <button className="bg-btnColor rounded-[10px] shadow-2xl shadow-zinc-950/50 p-3  cursor-pointer " onClick={() => swiperRef.current?.slidePrev()}>минуле</button>
        <button className="bg-btnColor rounded-[10px] shadow-2xl shadow-zinc-950/50 p-3 cursor-pointer  " onClick={() => swiperRef.current?.slideNext()}>наступне</button>
      </div>
    </>
  );
}
