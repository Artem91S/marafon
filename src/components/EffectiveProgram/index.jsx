...
function EffectiveProgram() {
  ...
  return (
    ...
    classNameBlock={'bg-gradient-to-t from-white to-[#eee] border-black'}
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 px-2 pb-6">
        {mainEffects.map((post) => (
          <div
            key={post.id}
            className="flex gap-6  max-w-[500px]"
          >
